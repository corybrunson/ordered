...
More will be added. Under consideration are:
 ...
 - ordinal regression via `ordinal::clm()` ([GitHub](https://github.com/runehaubo/ordinal))
 - ordinal regression via `VGAM::vglm()` ([website](https://www.stat.auckland.ac.nz/~yee/VGAM/))
